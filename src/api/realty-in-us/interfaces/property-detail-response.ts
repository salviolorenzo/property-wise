...
import { PropertyImage } from './get-images-response';
...
export type PropertDescription = {
  __typename: string;
...
export class PropertyDetail {
  ...
  list_date: string;
  create_date: string;
  mortgage: PropertMortgage;
  hoa: any;
  buyers: any;
  description: PropertDescription;
...
export type MappedPropertyDetail = Partial<
  CamelCasedPropertiesDeep<PropertyDetail>
>;
